...
// const MongoClient = require("mongodb").MongoClient;
// const uri = "mongodb://127.0.0.1:27017/jti_sheikh_lep";
const uri =
  "mongodb+srv://aktcl:01939773554op5t@cluster0.9akoo.mongodb.net/jti_sheikh_lep?retryWrites=true&w=majority";
const client = new MongoClient(uri, {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});
client.connect((err) => {
  const userCollection = client.db("jti_sheikh_lep").collection("users");
  const adminCollection = client.db("jti_sheikh_lep").collection("admins");
  const leadsCollection = client.db("jti_sheikh_lep").collection("leads");
